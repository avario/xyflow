...
import { FitViewParamsBase, FitViewOptionsBase, ZoomInOut, ZoomTo, SetViewport, GetZoom, GetViewport, SetCenter, FitBounds, XYPosition, OnBeforeDeleteBase, Connection, NodeChange, EdgeChange, Rect, EdgePosition } from '@xyflow/system';
...
export type EdgeTypeSelectionFunctions = Record<string, (edge: Edge, edgePosition: EdgePosition, rect: Rect) => boolean>;
